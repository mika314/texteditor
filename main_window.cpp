...
void MainWindow::saveAs(SaveDialog *sender, TextFile *textFile, const std::string &fileName)
{
...
void MainWindow::saveAndClose(SaveDialog *sender, TextFile *textFile, const std::string &fileName)
{
  tabs_.closeTextBuffer(sender);
